...
#app_training
$(BIN_DIRECTORY)/app_training: $(BIN_DIRECTORY)/main_training.o $(SRC_DIRECTORY)/m_learning.o $(SRC_DIRECTORY)/world.o $(SRC_DIRECTORY)/draw.o $(SRC_DIRECTORY)/car.o $(SRC_DIRECTORY)/capteur.o $(SRC_DIRECTORY)/display.o
	$(GXX) $^ -o $@ $(FLAGS)
...
$(SRC_DIRECTORY)/display.o: $(SRC_DIRECTORY)/display.cpp $(SRC_DIRECTORY)/display.h
	$(GXX) -o $@ -c $<
